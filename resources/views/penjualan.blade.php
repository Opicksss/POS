...
@section('sub header')
    <div class="sub-header">
        <div class="container">
            <h1 class="text-right">Transaction</h1>
        </div>
    </div>
@endsection
                    ...
                    <div class="row grid">
                        ...
                        <div id="gridItem01" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item pizza">
                            <div class="item-body">
                                <figure>
                                    ...
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/01.jpg"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="javascript:;" class="add-options-item-to-cart"><i
                                                class="icon icon-shopping-cart"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div id="gridItem02" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item  pizza">
                            <div class="item-body">
                                <figure>
                                    <div class="ribbon-discount"><span>- 10%</span></div>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/02.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem03" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item  pizza">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/03.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem04" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item  pizza">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/04.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem05" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item  vegetarian">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/05.jpg"
                                        class="img-fluid lazy" alt="">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="javascript:;" class="add-item-to-cart"><i
                                                class="icon icon-shopping-cart"></i></a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div id="gridItem06" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item  vegetarian">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/06.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem07" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item  vegetarian">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/07.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem08" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item  vegetarian">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/08.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem09" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item burger">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/09.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem10" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item burger">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/10.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem11" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item burger">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/11.jpg"
                                        class="img-fluid lazy" alt="">
                        ...
                        <div id="gridItem12" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 isotope-item burger">
                            <div class="item-body">
                                <figure>
                                    <img src="img/bg/lazy-placeholder.jpg" data-src="img/gallery/grid-items/12.jpg"
                                        class="img-fluid lazy" alt="">
                ...
                <div class="col-lg-4" id="sidebar">
                    ...
                    <div id="orderContainer" class="theiaStickySidebar">
                        ...
                        <form method="POST" id="orderForm" name="orderForm"
                            onsubmit="return confirmGuestOrder(event);">
                                ...
                                <div class="order-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <label class="cbx radio-wrapper no-edges">
                                                <input type="radio" value="delivery" name="transfer" checked> <span
                                                    class="checkmark"></span>
                                                <span class="radio-caption">Delivery Fee</span><span
                                                    class="option-price format-price transfer">10.00</span>
                                            </label>
                                        </div>
                                    </div>
                                    <!-- Delivery Fee -->
                                    ...
                                    <div class="row total-container">
                                        <div class="col-md-12 p-0">
                                            <span class="totalTitle">Total</span><span
                                                class="totalValue format-price float-right">0.00</span>
                                            <input type="hidden" id="totalOrderSummary" class="total format-price"
                                                name="total" value="" data-parsley-errors-container="#totalError"
                                                data-parsley-empty-order="" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" name="forward" class="btn-form-func forward">
                                                ...
                                                <span class="icon"><i class="fa fa-chevron-right"
                            ...
                            <div class="step">
                                ...
                                <div id="personalDetails"
                                    data-return-url='https://ultimatewebsolutions.net/foodboard/pay-with-cash-on-delivery/thank-you.php'
                                    data-currency='USD'>
                                    <div class="order-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="userNameCashPayment" class="form-control" name="username"
                                                        type="text" data-parsley-pattern="^[a-zA-Z\s.]+$" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="phoneCashPayment" class="form-control" name="phone"
                                                        type="text" data-parsley-pattern="^\+{1}[0-9]+$" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="emailCashPayment" class="form-control" name="email"
                                                        type="email" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="addressCashPayment" class="form-control" name="address"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="messageCashPayment" class="form-control" name="message"
                                                        type="text" data-parsley-pattern="^[a-zA-Z0-9\s.:,!?']+$" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 pr-0">
                                                <div class="form-group">
                                                    <input type="checkbox" id="cbxCashPayment" class="inp-cbx"
                                                    ...
                                                    <label class="cbx terms" for="cbxCashPayment">
                                                        ...
                                                        <span>Accept<a href="pdf/terms.pdf" class="terms-link"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" name="submit" id="submitOrder"
                                                    class="btn-form-func">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" name="backward"
                                                    class="btn-form-func btn-form-func-alt-color backward">
                                                    <span class="btn-form-func-content">Back</span>
                                                    <span class="icon"><i class="fa fa-chevron-left"
                                                            aria-hidden="true"></i></span>
                                                </button>
                                            </div>
                                        </div>
