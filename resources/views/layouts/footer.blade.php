    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled nav-links">
                    <li><i class="fa fa-angle-right"></i> <a href="pay-with-card-online/index.html"
                            class="footer-link">Pay online</a></li>
                    <li><i class="fa fa-angle-right"></i> <a href="index.html" class="footer-link">Pay with cash on
                            delivery</a></li>
                </ul>
            </div>
            <div class="col-md-4">
